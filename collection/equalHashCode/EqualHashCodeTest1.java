...
public class EqualHashCodeTest1 {
    public static void main(String[] args) {
        EqualHashCode e1 = new EqualHashCode(100, "rajkumar", 500);
        EqualHashCode e2 = new EqualHashCode(100, "rajkumar", 500);
        EqualHashCode e3 = new EqualHashCode(200, "rajkumar", 100);  
